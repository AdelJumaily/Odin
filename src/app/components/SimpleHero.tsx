    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Main Headline - Simple version without ScrambleText */}
          <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4 justify-center">
            <a 
              href="/login"
              className="w-40 h-12 rounded-full bg-[#811bf6] border border-[#811bf6] text-white text-sm font-semibold hover:bg-[#6b1bb8] transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-[#811bf6]/25 flex items-center justify-center"
            >
              Get Started
            </a>
            <a 
